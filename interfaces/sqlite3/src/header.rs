...
impl Header {
        ...
        T: Read + Seek,
    {
        ...
        out.reserved_len = buf.read_u8()?;
        out.max_emb_payload_fraction = buf.read_u8()?;
        out.min_emb_payload_fraction = buf.read_u8()?;
        out.leaf_payload_fraction = buf.read_u8()?;
        out.file_change_counter = buf.read_be_u32()?;
        out.page_count = buf.read_be_u32()?;
        out.first_freelist_page_id = buf.read_be_u32()?;
        out.freelist_page_count = buf.read_be_u32()?;
        out.schema_cookie = buf.read_be_u32()?;
        out.schema_format_number = buf.read_be_u32()?;
        out.default_page_cache_size = buf.read_be_u32()?;
        out.auto_vacuum_max_leaf_page = buf.read_be_u32()?;
        out.text_encoding = buf.read_be_u32()?;
        out.user_version = buf.read_be_u32()?;
